...
function TickerCard({ market }: { market: TickerMarket }) {
  ...
  return (
    ...
    >
      <div className="shrink-0 w-7 h-7 rounded-lg overflow-hidden bg-muted border border-border">
        <MarketImage
          src={getMarketImage({ image_url: market.image_url, category: market.category, id: market.id })}
          alt=""
          width={28}
          height={28}
